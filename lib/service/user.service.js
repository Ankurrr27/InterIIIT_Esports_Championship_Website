...
export const registerUser = async (data) => {
  ...
  const isCollegeEmailValid = await validateCollegeEmail(collegeEmail);
  ...
  const isMatchValid = await validateCollegeEmailMatch(college, collegeEmail);
  if (!isMatchValid) {
    throw new Error(
...
export const loginUser = async ({ collegeEmail, password }) => {
    ...
    // Find the user strictly by collegeEmail

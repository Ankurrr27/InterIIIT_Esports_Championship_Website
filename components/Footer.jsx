...
function Footer() {
  return (
    <footer className="relative border-t border-black/10 bg-white text-slate-900 overflow-hidden">
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="space-y-6 lg:col-span-4">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-[family-name:var(--font-display)] tracking-wide text-slate-900 sm:text-4xl">
                Built for the Event.
              </h2>
            </div>
            
            <p className="max-w-sm text-sm leading-7 text-slate-600 font-medium">
            ...
            <div className="flex gap-4">
              <a href="#" className="flex h-10 w-10 items-center justify-center border border-black/10 bg-slate-50 text-slate-500 transition hover:bg-red-600 hover:text-white hover:border-red-600">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center border border-black/10 bg-slate-50 text-slate-500 transition hover:bg-[#5865F2] hover:text-white hover:border-[#5865F2]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center border border-black/10 bg-slate-50 text-slate-500 transition hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000]">
              ...
              <a href="#" className="flex h-10 w-10 items-center justify-center border border-black/10 bg-slate-50 text-slate-500 transition hover:bg-[#1DA1F2] hover:text-white hover:border-[#1DA1F2]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:col-span-8">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm text-slate-600 font-medium">
                <li>
                  <Link href="/" className="group flex items-center transition hover:text-red-600">
                    <ChevronRight size={14} className="mr-2 opacity-0 transition-all group-hover:opacity-100 group-hover:text-red-600" />
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/event-details" className="group flex items-center transition hover:text-red-600">
                    <ChevronRight size={14} className="mr-2 opacity-0 transition-all group-hover:opacity-100 group-hover:text-red-600" />
                    Event Details
                  </Link>
                </li>
                <li>
                  <Link href="/register" className="group flex items-center transition hover:text-red-600">
                    <ChevronRight size={14} className="mr-2 opacity-0 transition-all group-hover:opacity-100 group-hover:text-red-600" />
                    Registration
                  </Link>
                </li>
                <li>
                  <Link href="/support" className="group flex items-center transition hover:text-red-600">
                    <ChevronRight size={14} className="mr-2 opacity-0 transition-all group-hover:opacity-100 group-hover:text-red-600" />
                    Support & FAQ
                  </Link>
                </li>
        ...
        {/* Bottom Banner */}
        <div className="mt-16 flex flex-col gap-4 border-t border-black/10 pt-8 text-sm text-slate-500 font-medium sm:flex-row sm:items-center sm:justify-between lg:mt-24">

        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-12 items-start">
          ...
          >
            ...
            >
              <a
                href="/register"
                className="group relative flex-1 sm:flex-none flex items-left justify-start gap-1.5 rounded-lg bg-red-600 px-3 py-2.5 sm:px-5 sm:py-2.5 text-[13px] sm:text-sm font-semibold text-white transition-all hover:bg-red-500 whitespace-nowrap"
              >

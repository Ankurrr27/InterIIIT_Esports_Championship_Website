...
const CollegeRequestSchema = new mongoose.Schema(
  {
    ...
    college_logo: { type: String, default: null },
    college_website: { type: String, default: null, trim: true },

    club_name: { type: String, required: true, trim: true },
    club_email: { type: String, required: true, trim: true, lowercase: true },
    club_instagram: { type: String, default: null, trim: true },
    ...
    whatsapp_number: { type: String, default: null, trim: true },
